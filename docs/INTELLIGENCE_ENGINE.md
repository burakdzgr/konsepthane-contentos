...
| **TREND** | Relative interest over time (Google Trends), visual/idea trend (Pinterest Trends), with direction and freshness. Stored as relative interest, never as search volume. | Search volume. Scraped data. |
